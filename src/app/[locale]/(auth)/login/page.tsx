  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          <div className="mb-1.5 flex items-center justify-between">
            <label className="text-sm font-semibold text-[#0D1801]">
              {t("password")}
            </label>
            <Link
              href="/forgot-password"
              className="text-xs font-semibold text-[#0D1801]/60 hover:text-[#0D1801]"
            >
              {t("forgotPassword")}
            </Link>
          </div>
      ...
      <p className="mt-6 text-center text-sm text-[#666]">
        {t("noAccount")}{" "}
        <Link href="/register" className="font-bold text-[#0D1801] hover:underline">
          {t("register")}
        </Link>
      </p>
    </div>
